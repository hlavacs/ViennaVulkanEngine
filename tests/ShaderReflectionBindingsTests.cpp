...
int main() {
   ...
   constexpr std::array expected{
      ...
      ExpectedBinding{1U, VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER, 8U, VK_SHADER_STAGE_FRAGMENT_BIT}, // baseColorTextures[kMaxSceneTextures]
      ExpectedBinding{2U, VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER, 1U, VK_SHADER_STAGE_FRAGMENT_BIT}, // spotShadowArray
      ExpectedBinding{3U, VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER, 1U, VK_SHADER_STAGE_FRAGMENT_BIT}, // dirShadowArray
      ExpectedBinding{4U, VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER, 1U, VK_SHADER_STAGE_FRAGMENT_BIT}, // pointShadowArray
   };
