...
namespace vve {
    ...
    SwapChain::SwapChain(VkPhysicalDevice physicalDevice, VkDevice device, VkSurfaceKHR surface, VkQueue presentQueue, CommandManager* commandManager, SDL_Window* window) :
    ...
    uint32_t SwapChain::getImageIndex(int currentFrame) {
    ...
    VkResult SwapChain::acquireNextImage(int currentFrame) {
        uint32_t imageIndex;
