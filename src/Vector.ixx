...
/**
	* @file
	* @brief Facade-owned segmented vector container used by public and simple runtime data structures.
	*
...
export namespace vve {
	...
	public:
		using implementation_type = Vector;							///< Facade compatibility alias for the vector value.
