...
namespace vh
{
    ...
    /*void initVulkan() {
        createInstance(&m_instance, m_vaidationLayers, m_instanceExtensions);
        ...
        createLogicalDevice(m_surface, m_physicalDevice, m_vaidationLayers, m_deviceExtensions, m_queueFamilies, m_device, m_graphicsQueue, m_presentQueue);
        initVMA(m_instance, m_physicalDevice, m_device, m_vmaAllocator);  
        createSwapChain(m_sdlWindow, m_surface, m_physicalDevice, m_device, m_swapChain);
        ...
        setupImgui(m_sdlWindow, m_instance, m_physicalDevice, m_queueFamilies, m_device, m_graphicsQueue, m_commandPool
