...
namespace vve::v3 {
   ...
   public:
      ...
      void registerTasks(TaskGraphBuilder &builder) {
         const auto begin_frame_task =
             builder.addTask("task.begin_frame", TaskKernelId::begin_frame, {},
                             {}, {}, "Begin Frame");
         const auto end_frame_task =
             builder.addTask("task.end_frame", TaskKernelId::end_frame, {}, {},
                             {}, "End Frame");
   ...
   GraphicsBackendFacade<
       VulkanGraphicsBackendImplementation>::GraphicsBackendFacade()
       : implementation_(
   ...
   std::string_view
   GraphicsBackendFacade<VulkanGraphicsBackendImplementation>::name()
       const noexcept {
   ...
   template <>
   vve::GraphicsApi
   GraphicsBackendFacade<VulkanGraphicsBackendImplementation>::api()
       const noexcept {
   ...
   template <>
   std::expected<void, vve::Error>
   GraphicsBackendFacade<VulkanGraphicsBackendImplementation>::init() {
      return implementation_->init();
   }

   template <>
   std::expected<void, vve::Error>
   GraphicsBackendFacade<VulkanGraphicsBackendImplementation>::beginFrame(
   ...
   template <>
   std::expected<void, vve::Error>
   GraphicsBackendFacade<VulkanGraphicsBackendImplementation>::endFrame(
       const FrameContext &frame_context) {
   ...
   template <>
   void
   GraphicsBackendFacade<VulkanGraphicsBackendImplementation>::registerTasks(
