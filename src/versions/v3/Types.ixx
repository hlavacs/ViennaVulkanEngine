...
export namespace vve::v3 {
   ...
   struct WindowSwapchainResources {
      ...
      std::uint32_t depth_image_count{0};       ///< Number of depth images created by the backend.
      std::uint32_t depth_image_view_count{0};  ///< Number of depth image views created by the backend.
      ...
      bool depth_image_created{false};          ///< Whether a VkImage was created for depth testing.
      bool depth_image_view_created{false};     ///< Whether a VkImageView was created for the depth image.
