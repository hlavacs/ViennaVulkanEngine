export module VEEngine.Simple.RenderPassContract;
import std;

/// @file
/// @brief Renderer-facing render-pass contract data shared without graph dependencies.
///
/// Functional objects:
/// - RenderMilestone provides stable milestone names used as dependency anchors between systems.
/// - RenderPassContract describes one planned render node and its educational verification data.
...
export namespace vve::simple {
	...
	struct RenderMilestone {
		...
		[[nodiscard]] static constexpr auto all() noexcept	-> std::array<std::string_view, 10>{
