export module VEEngine.V5:ECS;
import std;
export import :Types;

/// @file
/// @brief v5 ECS implementation.
...
export namespace vve::v5 {
	...
	/// @brief Small component store keyed by v5 entity handles.
	...
	template <typename TTraits> Entity BasicECS<TTraits>::create() {
		static_assert(!TTraits::use_slot_map_handles, "v5 prepares slot-map handles but has no slot map yet");
	...
	using ECS = BasicECS<>;	///< Default v5 ECS type.
