...
export namespace vve::v4 {
   ...
   struct RenderPassHandleTag {}; ///< v4 render-pass graph node handle tag.

   using RenderPassHandle = TypedHandle<RenderPassHandleTag>; ///< v4 render-pass graph node handle.
