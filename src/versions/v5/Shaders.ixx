...
export namespace vve::v5 {
   ...
   public:
      ...
      [[nodiscard]] VVE_V5_API bool containsShader(ShaderHandle handle) const;
      [[nodiscard]] VVE_V5_API std::expected<ObjectName, Error> shaderName(ShaderHandle handle) const;
      [[nodiscard]] VVE_V5_API std::expected<std::size_t, Error> shaderStageCount(ShaderHandle handle) const;
...
export namespace vve::v5 {
   ...
   VVE_V5_API std::expected<ShaderHandle, Error> ShaderSystem::addShader(ObjectName name, Vector<ShaderStage> stages) {
   ...
   VVE_V5_API std::expected<ObjectName, Error> ShaderSystem::shaderName(ShaderHandle handle) const {
   ...
   VVE_V5_API std::expected<std::size_t, Error> ShaderSystem::shaderStageCount(ShaderHandle handle) const {
      const auto shader = shaders_.find(handle);
      if (shader == shaders_.end()) { return std::unexpected(Error::missing_object); }
   ...
   VVE_V5_API std::expected<std::size_t, Error> ShaderSystem::spirvWordCount(ShaderHandle handle, ShaderStage stage) const {
   ...
   VVE_V5_API std::expected<bool, Error> ShaderSystem::hasReflectedBinding(ShaderHandle handle, std::string_view name) const {
      const auto *shader = find(handle);
      if (shader == nullptr) { return std::unexpected(Error::missing_object); }
   ...
   VVE_V5_API std::expected<bool, Error> ShaderSystem::hasReflectedType(ShaderHandle handle, std::string_view name) const {
      const auto *shader = find(handle);
      if (shader == nullptr) { return std::unexpected(Error::missing_object); }
   ...
   VVE_V5_API std::expected<Vector<ShaderBindingReflection>, Error> ShaderSystem::reflectedBindings(ShaderHandle handle) const {
      const auto *shader = find(handle);
      if (shader == nullptr) { return std::unexpected(Error::missing_object); }
   ...
   VVE_V5_API ShaderSystem::reflectedEntryPoints(ShaderHandle handle) const {
      const auto *shader = find(handle);
      if (shader == nullptr) { return std::unexpected(Error::missing_object); }
