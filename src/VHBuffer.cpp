...
namespace vh {
    ...
    void BufCopyBuffer(VkDevice device, VkQueue graphicsQueue, VkCommandPool commandPool, VkBuffer srcBuffer
  	...
  	void BufCreateTextureImage(VkPhysicalDevice physicalDevice, VkDevice device, VmaAllocator vmaAllocator, 
        ...
        BufTransitionImageLayout(device, graphicsQueue, commandPool, texture.m_mapImage, VK_FORMAT_R8G8B8A8_SRGB
    ...
    void BufCreateTextureImageView(VkDevice device, Map& texture) {
        texture.m_mapImageView = BufCreateImageView(device, texture.m_mapImage, VK_FORMAT_R8G8B8A8_SRGB
