...
#include "VEInclude.h"
#include "VESubrenderDF_Nuklear.h"
...
namespace ve {
    ...
    *
    */
    void VESubrenderDF_Nuklear::initSubrenderer() {
    ...
    void VESubrenderDF_Nuklear::closeSubrenderer() {
        nk_glfw3_shutdown();
    }

    void VESubrenderDF_Nuklear::prepareDraw() {
        nk_glfw3_new_frame();
    }

    VkSemaphore VESubrenderDF_Nuklear::draw(uint32_t imageIndex, VkSemaphore wait_semaphore) {
