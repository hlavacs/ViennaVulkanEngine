...
namespace ve {
	...
	*/
	void VESubrenderRT_DN::initSubrenderer() {
        ...
        vh::vhPipeCreateGraphicsPipelineLayout(getRendererRTPointer()->getDevice(),
			{ perObjectLayout, m_descriptorSetLayoutLights, m_descriptorSetLayoutOutput, m_descriptorSetLayoutAS, m_descriptorSetLayoutGeometry, m_descriptorSetLayoutObjectUBOs, m_descriptorSetLayoutResources },
			{ }, &m_pipelineLayout);
    ...
    void VESubrenderRT_DN::createRaytracingDescriptorSets()
    {
        ...
        vh::vhRenderCreateDescriptorSets(getRendererRTPointer()->getDevice(), getRendererRTPointer()->getSwapChainNumber(), m_descriptorSetLayoutLights, getRendererRTPointer()->getDescriptorPool(), m_descriptorSetsLights);
	...
	*/
	void VESubrenderRT_DN::bindDescriptorSetsPerFrame(VkCommandBuffer commandBuffer, uint32_t imageIndex,
        ...
        vkCmdBindDescriptorSets(commandBuffer, VK_PIPELINE_BIND_POINT_RAY_TRACING_NV, m_pipelineLayout,
            1, (uint32_t)set2.size(), set2.data(), 0, {});
	}
