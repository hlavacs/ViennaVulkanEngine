...
namespace ve {
    ...
    *
    */
    void VESubrenderRayTracingKHR::bindPipeline(VkCommandBuffer
                                                commandBuffer) {
...
*
*/
    void VESubrenderRayTracingKHR::bindDescriptorSetsPerFrame(VkCommandBuffer
                                                              commandBuffer,
                                                              uint32_t imageIndex,
                                                              VECamera
                                                              *pCamera,
...
*
*/
    void VESubrenderRayTracingKHR::bindDescriptorSetsPerEntity(VkCommandBuffer
                                                               commandBuffer,
...
*
*/
    void VESubrenderRayTracingKHR::draw(VkCommandBuffer
                                        commandBuffer,
                                        uint32_t imageIndex,
                                        uint32_t
                                        numPass,
...
*
*/
    void VESubrenderRayTracingKHR::drawEntity(VkCommandBuffer
                                              commandBuffer,
                                              uint32_t imageIndex, VEEntity
                                              *entity) {
    }
