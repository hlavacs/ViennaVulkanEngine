...
namespace ve {
    ...
    */
    ...
    protected:
        ...
        void callListeners2(double dt, veEvent event, std::vector<VEEventListener *> *list, uint32_t startIdx,
                            uint32_t endIdx);
    ...
    public:
        ...
        float getAcceptableLevel1() { return m_AcceptableLevel1; };

        ///\returns the percentage of frames with frame time < 16 ms (s)
        float getAcceptableLevel2() { return m_AcceptableLevel2; };
