...
namespace ve {
    ...
    */
    ...
    public:
        ...
        getThreadCommandPool() { return m_commandPools[getEnginePointer()->getThreadPool()->threadNum[std::this_thread::get_id()]]; };
        ...
        virtual VkDescriptorSetLayout getDescriptorSetLayoutOffscreen() { return m_descriptorSetLayoutOffscreen; };
        ...
        virtual std::vector<VkDescriptorSet> &getDescriptorSetsOffscreen() { return m_descriptorSetsOffscreen; };
