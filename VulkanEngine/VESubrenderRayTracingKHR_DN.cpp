...
namespace ve {
    ...
    VESubrenderRayTracingKHR_DN::VESubrenderRayTracingKHR_DN(VERendererRayTracingKHR &renderer) : VESubrenderRayTracingKHR(renderer)
    {
    ...
    *
    */
    void VESubrenderRayTracingKHR_DN::bindPipeline(VkCommandBuffer commandBuffer) {
    ...
    *
    */
    void VESubrenderRayTracingKHR_DN::bindDescriptorSetsPerFrame(VkCommandBuffer commandBuffer, uint32_t imageIndex,
    ...
    *
    */
    void VESubrenderRayTracingKHR_DN::bindDescriptorSetsPerEntity(VkCommandBuffer commandBuffer, uint32_t imageIndex, VEEntity *entity) {
    ...
    */
    void VESubrenderRayTracingKHR_DN::draw(VkCommandBuffer commandBuffer, uint32_t imageIndex,
        ...
        vkCmdPushConstants(commandBuffer, m_pipelineLayout, VK_SHADER_STAGE_CLOSEST_HIT_BIT_KHR, 0, sizeof(m_pushConstants), &m_pushConstants);
    ...
    *
    */
    void VESubrenderRayTracingKHR_DN::setDynamicPipelineState(VkCommandBuffer commandBuffer, uint32_t numPass)
    {
        if (numPass == 0)
        {
