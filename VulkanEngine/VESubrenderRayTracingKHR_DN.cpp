...
namespace ve {
    ...
    */
    ...
    void VESubrenderRayTracingKHR_DN::createShaderBindingTable() {
        ...
        VECHECKRESULT(
                vkGetRayTracingShaderGroupHandlesKHR(m_renderer.getDevice(), m_pipelines[0], 0, groupCount, sbtSize,
    ...
    */
    void VESubrenderRayTracingKHR_DN::bindPipeline(VkCommandBuffer
                                                   commandBuffer) {
        vkCmdBindPipeline(commandBuffer, VK_PIPELINE_BIND_POINT_RAY_TRACING_KHR, m_pipelines[0]
        );    //bind the PSO
    }
    ...
    void VESubrenderRayTracingKHR_DN::drawEntity(VkCommandBuffer
        ...
        const uint32_t handleSizeAligned =
                (rayTracingPipelineProperties.shaderGroupHandleSize +
                 ...
                 1) & ~(rayTracingPipelineProperties.shaderGroupHandleAlignment - 1);

        VkStridedDeviceAddressRegionKHR raygenShaderSbtEntry{};
        raygenShaderSbtEntry.
                deviceAddress = vh::vhGetBufferDeviceAddress(m_renderer.getDevice(), m_SBTBuffer);
        raygenShaderSbtEntry.
        ...
        missShaderSbtEntry.
                deviceAddress = vh::vhGetBufferDeviceAddress(m_renderer.getDevice(), m_SBTBuffer) + handleSizeAligned;
        missShaderSbtEntry.
                stride = handleSizeAligned;
        missShaderSbtEntry.
                size = handleSizeAligned * 2;
        ...
        vkCmdTraceRaysKHR(commandBuffer,
                          ...
                          swapChainExtent
                                  .width, swapChainExtent.height, 1);
    }
