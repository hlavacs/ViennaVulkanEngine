...
namespace ve {
    ...
    */
    void VESubrenderDF_Composer::initSubrenderer() {
        ...
        vh::vhPipeCreateGraphicsPipelineLayout(m_renderer.getDevice(),
            { perObjectLayout, perObjectLayout, m_renderer.getDescriptorSetLayoutShadow(), offscreenLayout },
            {  },
            &m_pipelineLayout);
    ...
    *
    */
    void VESubrenderDF_Composer::bindDescriptorSetsPerFrame(VkCommandBuffer commandBuffer, uint32_t imageIndex,
