...
namespace ve {
    ...
    */
    ...
    VESceneNode::VESceneNode(std::string name, glm::mat4 transf) : VENamedClass(name), m_parent(nullptr),
                                                                   m_transform(transf) {
    }
    ...
    */
    void VEEntity::updateUBO(glm::mat4 worldMatrix, uint32_t imageIndex) {
        ...
        VESceneObject::updateUBO((void *) &ubo, (uint32_t)
                sizeof(veUBOPerEntity_t), imageIndex);
...
*/
    void VECamera::updateUBO(glm::mat4 worldMatrix, uint32_t imageIndex) {
        ...
        VESceneObject::updateUBO((void *) &m_ubo, (uint32_t)
                sizeof(veUBOPerCamera_t), imageIndex);
    }
...
*/
    void VELight::updateUBO(glm::mat4 worldMatrix, uint32_t imageIndex) {
        ...
        VESceneObject::updateUBO((void *) &m_ubo, (uint32_t)
                sizeof(veUBOPerLight_t), imageIndex);
    }
