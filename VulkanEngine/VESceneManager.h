...
namespace ve {
    ...
    */
    ...
    protected:
        ...
        void createMaterials(const aiScene *pScene, std::string basedir, std::string filekey,
        ...
        VEEntity *createEntity2(std::string entityName, VEEntity::veEntityType type, VEMesh *pMesh, VEMaterial *pMat,
                                VESceneNode *parent, glm::mat4 transf = glm::mat4(1.0f));
        ...
        void updateSceneNodes3(std::vector<VESceneNode *> &children, glm::mat4 worldMatrix, uint32_t startIdx,
    ...
    public:
        ...
        VEEntity *createEntity(std::string entityName, VEMesh *pMesh, VEMaterial *pMat, VESceneNode *parent,
                               glm::mat4 transf = glm::mat4(1.0f));

        VEEntity *createEntity(std::string entityName, VEEntity::veEntityType type, VEMesh *pMesh, VEMaterial *pMat,
                               VESceneNode *parent, glm::mat4 transf = glm::mat4(1.0f));

        VECamera *createCamera(std::string cameraName, VECamera::veCameraType type, VESceneNode *parent,
                               glm::mat4 transf = glm::mat4(1.0f));

        VELight *createLight(std::string lightName, VELight::veLightType type, VESceneNode *parent,
                             glm::mat4 transf = glm::mat4(1.0f));
