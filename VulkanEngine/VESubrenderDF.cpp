...
namespace ve {
	...
	*
	*/
	void VESubrenderDF::bindPipeline(VkCommandBuffer commandBuffer) {
	...
	*
	*/
	void VESubrenderDF::drawEntity(VkCommandBuffer commandBuffer, uint32_t imageIndex, VEEntity *entity) {
