...
namespace ve {
    ...
    */
    ...
    public:
        ...
        VESubrenderDF(VERendererDeferred &renderer) : m_renderer(renderer) {};
        ...
        virtual void
        draw(VkCommandBuffer commandBuffer, uint32_t imageIndex, uint32_t numPass, VECamera *pCamera, VELight *pLight,
