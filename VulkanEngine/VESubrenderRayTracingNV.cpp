...
namespace ve {
	...
	*
	*/
	void VESubrenderRayTracingNV::bindDescriptorSetsPerFrame(VkCommandBuffer commandBuffer, uint32_t imageIndex,
	...
	*
	*/
	void VESubrenderRayTracingNV::bindDescriptorSetsPerEntity(VkCommandBuffer commandBuffer, uint32_t imageIndex, VEEntity *entity) {
	...
	*
	*/
	void VESubrenderRayTracingNV::draw(	VkCommandBuffer commandBuffer, uint32_t imageIndex,
								uint32_t numPass,
								VECamera *pCamera, VELight *pLight,
								std::vector<VkDescriptorSet> descriptorSetsShadow) {
	...
	*
	*/
	void VESubrenderRayTracingNV::drawEntity(VkCommandBuffer commandBuffer, uint32_t imageIndex, VEEntity *entity) {
	}
